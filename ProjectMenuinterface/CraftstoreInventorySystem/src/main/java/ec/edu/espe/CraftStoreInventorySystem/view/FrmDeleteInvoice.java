...
public class FrmDeleteInvoice extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmDeleteInvoice
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eliminación de Factura");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDeleteInvoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmDeleteInvoice().setVisible(true);
            }
        });
    }
